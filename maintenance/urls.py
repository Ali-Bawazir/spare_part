...
urlpatterns = [
    ...
    path("tools/dashboard/", views.tool_dashboard, name="tool_dashboard"),
    path("tools/damage/", views.tool_damage_global, name="tool_damage_global"),
    path("tools/<int:pk>/damage/", views.tool_damage_list, name="tool_damage_list"),
